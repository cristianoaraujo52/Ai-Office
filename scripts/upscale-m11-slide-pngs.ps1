...
$root = Join-Path (Get-Location) "public\slides\m11"
$backup = Join-Path (Get-Location) ".logs\m11-originals-1672x941-20260616"
$targetWidth = 3840
$targetHeight = 2160

New-Item -ItemType Directory -Force -Path $backup | Out-Null

$slideNames = foreach ($lesson in 1..5) {
  foreach ($index in 1..5) {
    "aula-11-$lesson-$($index.ToString('00')).png"
  }
}
