...
$root = Join-Path (Get-Location) "public\slides\m13"
$backup = Join-Path (Get-Location) ".logs\m13-originals-1672x941-20260616"
$targetWidth = 3840
$targetHeight = 2160

New-Item -ItemType Directory -Force -Path $backup | Out-Null

$slideNames = foreach ($lesson in 1..4) {
  foreach ($index in 1..5) {
    "aula-13-$lesson-$($index.ToString('00')).png"
  }
}
