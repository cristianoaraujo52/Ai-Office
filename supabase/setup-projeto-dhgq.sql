-- SETUP PARA O PROJETO dhgq (já tem tabelas da versão antiga). JÁ APLICADO em 21/09/2026.
-- Roda em uma transação: se algo falhar, nada é aplicado.
-- (profile-admin-policies.sql ficou de fora: causava recursão infinita em profiles.)

BEGIN;
-- ===================== preparar-projeto-existente.sql =====================
-- ============================================================
